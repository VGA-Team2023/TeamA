...
public static class CriAtomEx
{
	 ...
	 * <remarks>
	 * <para header='説明'>CriWare.CriAtomExPlayer が内部で作成するサウンドレンダラの種別をを表します。</para>
	 * </remarks>
	 */
	 ...
	 * <remarks>
	 * <para header='説明'>CriWare.CriAtomExPlayer がボイスを確保する際の動作仕様を指定するためのデータ型です。</para>
	 * </remarks>
	 ...
	 * CriWare.CriAtomExPlayer::SetBiquadFilterParameters 関数で利用します。</para>
	 * </remarks>
	 ...
	 * CriWare.CriAtomExPlayer::Resume 関数、および CriWare.CriAtomExPlayback::Resume
	 * 関数の引数として使用します。</para>
	 * </remarks>
	 ...
	 * CriWare.CriAtomExPlayer::SetPanType 関数で利用します。<br/></para>
	 * </remarks>
	 ...
	 * CriWare.CriAtomExPlayer::SetVoiceControlMethod 関数で利用します。<br/></para>
	 * </remarks>
	 ...
	 * CriWare.CriAtomExPlayer::GetParameterFloat32 関数等で利用します。</para>
	 * </remarks>
	 ...
	 * CriWare.CriAtomExPlayer::SetSendLevel 関数で利用します。</para>
	 * </remarks>
	 ...
	 * CriWare.CriAtomExPlayer::SetFormat 関数で利用します。<br/></para>
	 * </remarks>
	 ...
	 * <remarks>
	 * <para header='説明'>エンベロープカーブやREACTのダッキング曲線として使用するカーブタイプです。<br/></para>
	 * </remarks>
	 * <seealso cref='CriAtomExPlayer::SetEnvelopeAttackCurve'/>
	 * <seealso cref='CriAtomExPlayer::SetEnvelopeDecayCurve'/>
	 * <seealso cref='CriAtomExPlayer::SetEnvelopeReleaseCurve'/>
	 ...
	 * <para header='説明'>バーチャルスピーカーにおけるパン3Dや3Dポジショニングの計算時に使用する、<br/>
	 * 出力スピーカーの角度（配置）を設定します。<br/></para>
	 * <para header='注意'>本関数での設定は CriWare.CriAtomEx::ControlVirtualSpeakerSetting 関数にて<br/>
	 ...
	 * この設定を有効にすると、マルチチャンネルサウンドは CriWare.CriAtomEx::SetVirtualSpeakerAngle 関数にて設定した<br/>
	 ...
	 * CriWare.CriAtomExAcb::GetUsableAisacControl 関数に引数として渡します。<br/></para>
	 * </remarks>
	...
	public struct AisacControlInfo {
		...
		public AisacControlId   id;         /**< AISACコントロールID */
	...
	public struct CuePos3dInfo
	{
		...
		public AisacControlId distanceAisacControl;              /**< 距離減衰AISACコントロール */
		public AisacControlId listenerBaseAngleAisacControl;     /**< リスナー基準角度AISACコントロール */
		public AisacControlId sourceBaseAngleAisacControl;       /**< 音源基準角度AISACコントロール */
		public AisacControlId listenerBaseElevationAisacControl; /**< リスナー基準仰俯角AISACコントロール */
		public AisacControlId sourceBaseElevationAisacControl;   /**< 音源基準仰俯角AISACコントロール */
	 ...
	 * CriWare.CriAtomEx::GetGameVariableInfo 関数に引数として渡します。<br/></para>
	 * </remarks>
	...
	* <remarks>
	* <para header='説明'>無音時処理モードを指定するためのデータ型です。<br/>
	* 無音となったかどうかは、以下のいずれかの値が0になったかどうかで判断します。<br/>
	* - ボリューム<br/>
	* - 3Dパンニングの演算結果によるボリューム<br/>
	* - 3Dポジショニングの演算結果によるボリューム<br/></para>
	* <para header='注意'>センドレベルや2Dパンの設定値では無音と判断されない点にご注意ください。</para>
	* </remarks>
	*/
	public enum SilentMode : System.Int32 {
		/**
		 * <summary>何もしない</summary>
		 * <remarks>
		 * <para header='説明'>無音となっても特別な処理は行いません。（デフォルト値）</para>
		 * </remarks>
		 */
		Normal = 0,
		/**
		 ...
		 * <remarks>
		 * <para header='説明'>無音となった際は自動的に停止します。</para>
		 * </remarks>
		 */
		Stop = 1,
		/**
		 ...
		 * <remarks>
		 * <para header='説明'>無音となった際は自動的にバーチャル化します。</para>
		 * </remarks>
		 */
		Virtual = 2,
		/**
		 ...
		 * <remarks>
		 * <para header='説明'>無音となった際は自動的に再発音型でバーチャル化します。</para>
		 * </remarks>
		 */
		VirtualRetrigger = 3,
	}
	 ...
	 * CriWare.CriAtomEx::GetPerformanceInfo 関数で利用します。</para>
	 * </remarks>
	...
	public static bool RegisterAcf(CriFsBinder binder, string acfPath)
	{
		...
		return criAtomEx_RegisterAcfFile(binderHandle, acfPath, IntPtr.Zero, 0);
	}
	...
	*/
	 ...
	 * ではなく、 CriWare.CriAtomConfig::useRandomSeedWithTime プロパティを使用してください。
	 * <br/></para>
	 * <para header='注意'>本関数は CriWare.CriAtomSource または CriWare.CriAtomExPlayer の生成前に呼び出す必要が
	 ...
	 * 本関数実行後、 CriWare.CriAtomEx::Unlock 関数実行までの間、サーバ処理の動作が抑止されます。<br/>
	 ...
	 * <remarks>
	 * <para header='説明'>CriWare.CriAtomEx::Lock 関数による、サーバ処理の割り込み防止を解除します。</para>
	 * </remarks>
	...
	/**
	 * <summary>センドレベル値が無い場合のオフセット値有効化</summary>
	 * <param name='enable'>有効化フラグ</param>
	 * <remarks>
	 * <para header='説明'><see cref='CriWare.CriAtomExPlayer.SetBusSendLevelOffset'/> などでセンド量を設定した際に<br/>
	 * データ側にセンドレベル値設定が無くてもオフセット値を加味するかを設定します。<br/>
	 * 有効化フラグ値に対応する挙動は以下の通りです。<br/>
	 * - ture:すべてのバスに対してオフセットを指定する<br/>
	 * - false:データ側でセンド先が設定されているバスのみ<br/>
	 * システムデフォルトは true です。<br/>
	 * 再生中の音声に対しては、パラメーターの更新適用時に合わせて反映されます。</para>
	 * </remarks>
	 */
	static public void EnableBusSendOffsetWhenLevelNotExist(bool enable)
	{
	...
	private static bool criAtomEx_RegisterAcfData(
		IntPtr acfData, int acfDataSize, IntPtr work, int workSize) { return true; }
	private static bool criAtomEx_RegisterAcfData(
		byte[] acfData, int acfDataSize, IntPtr work, int workSize) { return true; }
	...
	private static void criAtomEx_EnableBusSendOffsetWhenLevelNotExist(bool enable) { }
	#if UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN
...
public static class CriAtomExCategory
{
	 ...
	 * \deprecated
	 * 削除予定の非推奨APIです。
	 * CriAtomEx.CurveTypeの使用を検討してください。
	*/
	[Obsolete("Use CriAtomEx.CurveType instead")]
	public enum ReactDuckerCurveType : int
	{
		Linear = CriAtomEx.CurveType.Linear,                    /**< 直線 */
		Square = CriAtomEx.CurveType.Square,                    /**< 低速変化 */
		SquareReverse = CriAtomEx.CurveType.SquareReverse,      /**< 高速変化 */
		SCurve = CriAtomEx.CurveType.SCurve,                    /**< S字曲線 */
		FlatAtHalf = CriAtomEx.CurveType.FlatAtHalf,            /**< 逆S字曲線 */
	}
	...
	{
		public CriAtomEx.CurveType      curveType;      /**< 変化曲線タイプ */
	 ...
	 * カテゴリを名前で指定する以外は、
	 * CriWare.CriAtomExCategory::Pause(int, bool)  関数と仕様は同じです。<br/></para>
	 * </remarks>
	 ...
	 * （ CriWare.CriAtomExPlayer::Pause 関数や CriWare.CriAtomExPlayback::Pause 関数でのポーズ）とは独立して扱われ、
	 ...
	 * CriWare.CriAtomExCategory::SetAisacControl 関数と仕様は同じです。<br/></para>
	 * </remarks>
	...
	*/
	...
	/**
	 * <summary>ID指定によるカテゴリに所属する発音中キューの停止</summary>
	 * <param name='id'>カテゴリID</param>
	 * <remarks>
	 * <para header='説明'>指定したカテゴリに所属する発音中のキューを停止します。</para>
	 * </remarks>
	 */
 	...
 	/**
	 * <summary>名前指定によるカテゴリに所属する発音中キューの停止</summary>
	 * <param name='name'>カテゴリ名</param>
	 * <remarks>
	 * <para header='説明'>指定したカテゴリに所属する発音中のキューを停止します。</para>
	 * </remarks>
	...
	/**
	 * <summary>ID指定によるカテゴリに所属する発音中キューの即時停止</summary>
	 * <param name='id'>カテゴリID</param>
	 * <remarks>
	 * <para header='説明'>指定したカテゴリに所属する発音中のキューを即時停止します。</para>
	 * </remarks>
	 */
	...
	/**
	 * <summary>名前指定によるカテゴリに所属する発音中キューの即時停止</summary>
	 * <param name='name'>カテゴリ名</param>
	 * <remarks>
	 * <para header='説明'>指定したカテゴリに所属する発音中のキューを即時停止します。</para>
	 * </remarks>
	 ...
	 * <returns>カテゴリボリューム</returns>
	 * <remarks>
	 * <para header='説明'>ID指定でREACT、AISACなどの影響を受けた最終的なカテゴリのボリューム値を取得します。</para>
	 * <para header='備考'>最終的なカテゴリのボリューム値を取得するためにパラメーターの計算処理を行うので、負荷が大きい関数です。</para>
	 * </remarks>
	 */
	...
	/**
	 * <summary>ID指定によるフェードイン時間の設定</summary>
	 * <param name='id'>カテゴリID</param>
	 * <param name='ms'>フェードイン時間（ミリ秒単位）</param>
	 * <remarks>
	 * <para header='説明'>カテゴリにフェードイン時間を設定します。<br/>
	 * フェードイン時間はポーズ解除を行った際に利用されます。</para>
	 * </remarks>
	 */
	...
	/**
	 * <summary>名前指定によるフェードイン時間の設定</summary>
	 * <param name='name'>カテゴリ名</param>
	 * <param name='ms'>フェードイン時間（ミリ秒単位）</param>
	 * <remarks>
	 * <para header='説明'>カテゴリにフェードイン時間を設定します。<br/>
	...
	/**
	 * <summary>ID指定によるフェードアウト時間の設定</summary>
	 * <param name='id'>カテゴリID</param>
	 * <param name='ms'>フェードアウト時間（ミリ秒単位）</param>
	 * <remarks>
	 * <para header='説明'>カテゴリにフェードアウト時間を設定します。<br/>
	 * フェードアウト時間はポーズを行った際に利用されます。</para>
	 * </remarks>
	 */
	...
	/**
	 * <summary>名前指定によるフェードアウト時間の設定</summary>
	 * <param name='name'>カテゴリ名</param>
	 * <param name='ms'>フェードアウト時間（ミリ秒単位）</param>
	 * <remarks>
	 * <para header='説明'>カテゴリにフェードアウト時間を設定します。<br/>
	...
	/**
	 * <summary>ID指定でカテゴリにアタッチされている全てのAISACコントロール値をデフォルト値に設定</summary>
	 * <param name='id'>カテゴリID</param>
	 * <returns>設定に成功したか？（true:成功した, false:失敗した）</returns>
	 * <remarks>
	 * <para header='説明'>カテゴリにアタッチされている全てのAISACコントロール値をデフォルト値に設定します。<br/>
	 * 存在しないカテゴリを指定した場合、falseが返ります。</para>
	 * </remarks>
	 */
	...
	/**
	 * <summary>名前指定でカテゴリにアタッチされている全てのAISACコントロール値をデフォルト値に設定</summary>
	 * <param name='name'>カテゴリ名</param>
	 * <returns>設定に成功したか？（true:成功した, false:失敗した）</returns>
	 * <remarks>
	 * <para header='説明'>カテゴリにアタッチされている全てのAISACコントロール値をデフォルト値に設定します。<br/>
	...
	/**
	 * <summary>ID指定でカテゴリにAISACを取り付け</summary>
	 * <param name='id'>カテゴリID</param>
	 * <param name='globalAisacName'>取り付けるグローバルAISAC名</param>
	 * <remarks>
	 * <para header='説明'>カテゴリにAISACをアタッチ（取り付け）します。<br/>
	 * AISACをアタッチすることにより、キューやトラックにAISACを設定していなくても、AISACの効果を得ることができます。<br/>
	 * <br/>
	 * AISACのアタッチに失敗した場合、関数内でエラーコールバックが発生します。<br/>
	 * AISACのアタッチに失敗した理由については、エラーコールバックのメッセージを確認してください。</para>
	 * <para header='備考'>全体設定（ACFファイル）に含まれるグローバルAISACのみ、アタッチ可能です。<br/>
	 * AISACの効果を得るには、キューやトラックに設定されているAISACと同様に、該当するAISACコントロール値を設定する必要があります。<br/></para>
	 * <para header='注意'>キューやトラックに「AISACコントロール値を変更するAISAC」が設定されていたとしても、その適用結果のAISACコントロール値は、カテゴリにアタッチしたAISACには影響しません。<br/>
	 ...
	 * 現在、カテゴリにアタッチできるAISACの最大数は、8個固定です。</para>
	 * </remarks>
	 * <seealso cref='CriAtomExCategory::DetachAisac'/>
	 */
	...
	/**
	 * <summary>名前指定でカテゴリにAISACを取り付け</summary>
	 * <param name='name'>カテゴリ名</param>
	 * <param name='globalAisacName'>取り付けるグローバルAISAC名</param>
	 * <remarks>
	 * <para header='説明'>カテゴリにAISACをアタッチ（取り付け）します。<br/>
	...
	/**
	 * <summary>ID指定でカテゴリからAISACを取り外し</summary>
	 * <param name='id'>カテゴリID</param>
	 * <param name='globalAisacName'>取り外すグローバルAISAC名</param>
	 * <remarks>
	 * <para header='説明'>カテゴリからAISACをデタッチ（取り外し）します。<br/>
	 * <br/>
	 * AISACのデタッチに失敗した場合、関数内でエラーコールバックが発生します。<br/>
	 * AISACのデタッチに失敗した理由については、エラーコールバックのメッセージを確認してください。</para>
	 * </remarks>
	 * <seealso cref='CriAtomExCategory::AttachAisac'/>
	 */
	...
	/**
	 * <summary>名前指定でカテゴリからAISACを取り外し</summary>
	 * <param name='name'>カテゴリ名</param>
	 * <param name='globalAisacName'>取り外すグローバルAISAC名</param>
	 * <remarks>
	 * <para header='説明'>カテゴリからAISACをデタッチ（取り外し）します。<br/>
	...
	/**
	 * <summary>ID指定でカテゴリから全てのAISACを取り外し</summary>
	 * <param name='id'>カテゴリID</param>
	 * <remarks>
	 * <para header='説明'>カテゴリから全てのAISACをデタッチ（取り外し）します。</para>
	 * </remarks>
	 */
	...
	/**
	 * <summary>名前指定でカテゴリから全てのAISACを取り外し</summary>
	 * <param name='name'>カテゴリ名</param>
	 * <remarks>
	 * <para header='説明'>カテゴリから全てのAISACをデタッチ（取り外し）します。</para>
	 * </remarks>
	...
	/**
	 * <summary>ID指定でカテゴリにアタッチされているAISAC数を取得</summary>
	 * <param name='id'>カテゴリID</param>
	 * <returns>カテゴリにアタッチされているAISAC数</returns>
	 * <remarks>
	 * <para header='説明'>カテゴリにアタッチされているAISAC数を取得します。<br/>
	 * 存在しないカテゴリを指定した場合、負値が返ります。</para>
	 * </remarks>
	 */
	...
	/**
	 * <summary>名前指定でカテゴリにアタッチされているAISAC数を取得</summary>
	 * <param name='name'>カテゴリ名</param>
	 * <returns>カテゴリにアタッチされているAISAC数</returns>
	 * <remarks>
	 * <para header='説明'>カテゴリにアタッチされているAISAC数を取得します。<br/>
	...
	/**
	 * <summary>ID指定でカテゴリに所属する発音中のキュー数を取得</summary>
	 * <param name='id'>カテゴリID</param>
	 * <returns>カテゴリに所属する発音中のキュー数</returns>
	 * <remarks>
	 * <para header='説明'>カテゴリに所属する発音中のキュー数を取得します。<br/>
	 * 存在しないカテゴリを指定した場合、負値が返ります。</para>
	 * </remarks>
	 */
	...
	/**
	 * <summary>名前指定でカテゴリに所属する発音中のキュー数を取得</summary>
	 * <param name='name'>カテゴリ名</param>
	 * <returns>カテゴリに所属する発音中のキュー数</returns>
	 * <remarks>
	 * <para header='説明'>カテゴリに所属する発音中のキュー数を取得します。<br/>
	...
	private static float criAtomExCategory_GetTotalVolumeById(int id) { return 0.0f; }
	private static float criAtomExCategory_GetTotalVolumeByName(string name) { return 0.0f; }
	private static void criAtomExCategory_SetFadeInTimeById(int id, ushort ms) { }
	private static void criAtomExCategory_SetFadeInTimeByName(string name, ushort ms) { }
	private static void criAtomExCategory_SetFadeOutTimeById(int id, ushort ms) { }
	private static void criAtomExCategory_SetFadeOutTimeByName(string name, ushort ms) { }
	private static bool criAtomExCategory_ResetAllAisacControlById(int category_id) { return false; }
	private static bool criAtomExCategory_ResetAllAisacControlByName(string category_name) { return false; }
	private static void criAtomExCategory_AttachAisacById(int id, string global_aisac_name) { }
	private static void criAtomExCategory_AttachAisacByName(string name, string global_aisac_name) { }
	private static void criAtomExCategory_DetachAisacById(int id, string global_aisac_name) { }
	private static void criAtomExCategory_DetachAisacByName(string name, string global_aisac_name) { }
	private static void criAtomExCategory_DetachAisacAllById(int id) { }
	private static void criAtomExCategory_DetachAisacAllByName(string name) { }
	private static int criAtomExCategory_GetNumAttachedAisacsById(int id) { return 0; }
	private static int criAtomExCategory_GetNumAttachedAisacsByName(string name) { return 0; }
	private static int criAtomExCategory_GetNumCuePlayingCountById(int id) { return 0; }
	private static int criAtomExCategory_GetNumCuePlayingCountByName(string name) { return 0; }
	private static void criAtomExCategory_StopById(int id) { }
	private static void criAtomExCategory_StopByName(string name) { }
	private static void criAtomExCategory_StopWithoutReleaseTimeById(int id) { }
	private static void criAtomExCategory_StopWithoutReleaseTimeByName(string name) { }
	#endif
...
public static class CriAtomExBeatSync
{
	...
	public struct Info {
		...
		public IntPtr   labelPtr;           /**< ビート同期ラベル情報を示すポインタ */

		/**
		 * <summary>ビート同期ラベル</summary>
		 * <remarks>
		 * <para header='説明'>ビート同期ラベルを表すプロパティです。<br/>
		 * ラベルが未設定の場合や該当キューの再生が終了している場合は null を返します。</para>
		 * <para header='注意'>本プロパティを参照すると、内部で文字列のアロケーションが発生します。<br/>
		 * 単一キューを再生した場合、ある種類のラベル文字列は同一の labelPtr を元に
		 * 変換されるため、比較などの用途でラベルを複数回参照する場合は labelPtr の利用をおすすめします。</para>
		 * </remarks>
		 */
		public string label {
			get {
				var playback = new CriAtomExPlayback(this.playbackId);
				var status = playback.GetStatus();
				if (status == CriAtomExPlayback.Status.Removed) {
					return null;
				}
				return Marshal.PtrToStringAnsi(this.labelPtr);
			}
		}
	}
...
public class CriAtomExAsr
{
	...
	public struct BusAnalyzerInfo
	{
		...
		public BusAnalyzerInfo(byte[] data)
		{
			if (data != null) {
				...
				this.rmsLevels = new float[16];
				for (int i = 0; i < 16; i++) {
					this.rmsLevels[i] = BitConverter.ToSingle(data, 4 + i * 4);
				}
				this.peakLevels = new float[16];
				for (int i = 0; i < 16; i++) {
					this.peakLevels[i] = BitConverter.ToSingle(data, 68 + i * 4);
				}
				this.peakHoldLevels = new float[16];
				for (int i = 0; i < 16; i++) {
					this.peakHoldLevels[i] = BitConverter.ToSingle(data, 132 + i * 4);
				}
			} else {
				this.numChannels = 0;
				this.rmsLevels = new float[16];
	...
	*/
	 ...
	 * <param name='volume'>ボリューム値</param>
	 * <remarks>
	 * <para header='説明'>バスのボリュームを取得します。<br/>
	 * <br/>
	 * ボリューム値は実数値で得られます。<br/>
	 * ボリュームのデフォルト値はCRI Atom Craftで設定した値です。</para>
	 * </remarks>
	 */
	...
	/**
	 * <summary>バイノーライザーの有効化</summary>
	 * <param name='enabled'>有効フラグ</param>
	 * <remarks>
	 * <para header='説明'>バイノーライザーの有効を指定します。<br/></para>
	 * <para header='備考'>バイノーライザーは <see cref='CriAtomEx.SoundRendererType'/> が Spatial であるASRラックでのみ使用可能です。<br/>
	 * バイノーライザーのスペシャライザーインタフェースが登録されている場合、登録したスペシャライザーを使用します。<br/>
	 * 登録されていない場合、Atom内蔵のスペシャライザーを使用します。<br/>
	 * <br/></para>
	 * <seealso cref='CriAtomExAsr.IsEnabledBinauralizer'/>
	 * </remarks>
	 */
	...
	/**
	 * <summary>バイノーライザーの有効化状態の取得</summary>
	 * <returns>有効化状態</returns>
	 * <remarks>
	 * <para header='説明'>バイノーライザーの有効化状態を取得します。<br/>
	 * <br/></para>
	 * <seealso cref='CriAtomExAsr.EnableBinauralizer'/>
	 * </remarks>
	 */
	...
	/**
	 * <summary>PCM出力の取得</summary>
	 * <param name='outputChannels'>取得するチャンネル数</param>
	 * <param name='outputSamples'>取得するPCMサンプル数</param>
	 * <param name='buffer'>PCMサンプル書き込み用バッファー</param>
	 * <returns>取得したPCMサンプル数</returns>
	 * <remarks>
	 * <para header='説明'>Atomからの出力となるPCMサンプルを取得します。<br/></para>
	 * <para header='注意'>本関数はEditor実行時専用です。<br/>
	 * ユーザーPCM出力モードを有効にして初期化した場合にのみ動作します。</para>
	 * </remarks>
	 */
	...
	/**
	 * <summary>取得可能なPCM出力サンプル数の取得</summary>
	 * <returns>取得可能なPCM出力サンプル数</returns>
	 * <remarks>
	 * <para header='説明'>取得可能なAtomからの出力となるPCMサンプル数を取得します。<br/></para>
	 * <para header='注意'>本関数はEditor実行時専用です。<br/>
	 * ユーザーPCM出力モードを有効にして初期化した場合にのみ動作します。</para>
	 * </remarks>
	 */
	...
	/**
	 * <summary>PCM出力サンプルのバッファーサイズの設定</summary>
	 * <param name='numSamples'>PCM出力サンプルのバッファーサイズ</param>
	 * <remarks>
	 * <para header='説明'>Atomからの出力となるPCMサンプルのバッファーサイズを設定します。<br/>
	 * 小さくすることで CriWare.CriAtomExAsr::GetPcmOutput で取得可能な出力の遅延が小さくなりますが、
	 * 呼び出しの頻度が十分でないと音途切れなどの問題が発生する場合があります。</para>
	 * <para header='注意'>本関数はEditor実行時専用です。<br/>
	 * ユーザーPCM出力モードを有効にして初期化した場合にのみ動作します。</para>
	 * </remarks>
	 */
...
public static class CriAtomExLatencyEstimator
{
	 ...
	 * CriWare.CriAtomExLatencyEstimator::GetCurrentInfo 関数で取得可能です。<br/>
	 * <br/></para>
	 * </remarks>
	 */
	public enum Status {
