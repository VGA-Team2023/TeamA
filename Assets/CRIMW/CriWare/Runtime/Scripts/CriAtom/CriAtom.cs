...
public static class CriAtomPlugin
{
	...
	public static void SetConfigParameters(int max_virtual_voices,
		...
		int max_faders, int num_buses, CriAtomEx.SoundRendererType sound_renderer_type, bool enable_sonicsync_for_common)
	{
		criAtomUnity_SetConfigParameters(max_virtual_voices,
			...
			max_faders, num_buses, sound_renderer_type, enable_sonicsync_for_common);
