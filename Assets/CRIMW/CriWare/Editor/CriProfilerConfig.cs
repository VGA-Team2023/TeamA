...
public partial class CriProfiler
{
	...
	public const int CRI_ATOM_PREVIEW_CONNECTION_VERSION = 0x00770000;
	...
	protected enum LogFuncId {
		...
		LOG_COMMAND_ExPlayer_SetNextBlockIndex,				/* criAtomExPlayer_SetNextBlockIndex */
	...
	static protected readonly LogParam[] LogParams = new LogParam[] {
		...
		new LogParam("Param_Float32",					LogParamTypes.TYPE_FLOAT32 ),				/* 255 */
		new LogParam("Param_Sint32",					LogParamTypes.TYPE_INT32 ),					/* 256 */
		new LogParam("Param_Uint32",					LogParamTypes.TYPE_INT32 ),					/* 257 */
		new LogParam("BlockIndex",						LogParamTypes.TYPE_INT32 ),					/* 257 */
		new LogParam("PlaybackCancelType",				LogParamTypes.TYPE_INT32 ),					/* 258 */	/* CriAtomExPlaybackCancelType */
	};
